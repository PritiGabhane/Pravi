...
public class Check_Answers_Teatcase 
{
	WebDriver driver;
	int count;
	Launch_Login LP; CheckAnswers_Page CP;
	...
	@Test(priority = 3)
	public void CheckAnswers_Page_Method() throws Exception 
	{
		CP = new CheckAnswers_Page(driver);
